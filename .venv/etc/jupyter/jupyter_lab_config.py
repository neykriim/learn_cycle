...
c.ServerApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$yPPersQdziUEHYETEzUsCQ$HNDxRR3Mb9qyRbrJttwcWY+7oAGj4VHj/F8Dt+rOGSU'  # Вставьте ваш хеш сюда
c.ServerApp.open_browser = False     # Не открывать браузер автоматически
c.ServerApp.port = 8888              # Порт (по желанию)
...
#  Default: '/home/prokofev.a@agtu.ru/.jupyter/lab/user-settings'
# c.LabApp.user_settings_dir = '/home/prokofev.a@agtu.ru/.jupyter/lab/user-settings'
...
#  Default: '/home/prokofev.a@agtu.ru/.jupyter/lab/workspaces'
# c.LabApp.workspaces_dir = '/home/prokofev.a@agtu.ru/.jupyter/lab/workspaces'
